...
class ClientProfile extends StatefulWidget {
  ClientProfile(this.clientId, this.trainerId) : super();
          ...
          return FutureBuilder<QuerySnapshot>(
              ...
              builder: (ctx, snapshot1) {
                ...
                if (restartChatNotificationButton == false) {
                  _trainerUser.unseenMessagesCounter.forEach((user) {
                    if (user.userId == bookedClient.id) {
                      seenFlag = true;
                    }
                  });
                }
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: flagFriendshipPending == true
                                    ? Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: <Widget>[
                                                                              Icon(
                                                                                Icons.local_dining,
                                                                                color: Colors.white,
                                                                                size: 12 * prefs.getDouble('height'),
                                                                              ),
                                                                              SizedBox(
                                                                      ...
                                                                      MaterialButton(
                                                                          onPressed:
                                                                            ...
                                                                            Navigator.push(context,
                                                                                ManagingSchedule(clientUser: bookedClient, imTrainer: _trainerUser));
                                                                          },
                                                                          child:
                                                                              Row(
                                                                            mainAxisSize:
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        Container(
                                                                            ...
                                                                            child: Center(
                                                                              child: Text(
                                                                                "${translate(preferencesList[0])}",
                                                                                style: TextStyle(fontFamily: 'Roboto', fontSize: 12 * prefs.getDouble('height'), fontWeight: FontWeight.w400, fontStyle: FontStyle.normal, color: Colors.white),
                                                                              ),
                                                                            )),
                                                                        SizedBox(
                                                                          width:
                                                                ...
                                                                : Container(
                                                                    ...
                                                                    child: Column(
                                                                        ...
                                                                        children: <
                                                                          ...
                                                                          Text(
                                                                              "No preferences set",
                                                                              style: TextStyle(fontFamily: 'Roboto', fontSize: 17.0 * prefs.getDouble('height'), color: Colors.white, fontWeight: FontWeight.normal, letterSpacing: -0.408),
                                                                              textAlign: TextAlign.center),
                                                                          SizedBox(
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child: Text("Setting preferences will help trainers meet your requirements.",
                                                                                style: TextStyle(
                                                                                  fontFamily: 'Roboto',
...
class DeletePermissionPopup1 extends PopupRoute<void> {
  DeletePermissionPopup1({this.clientUser, this.parent});
  final _ClientProfileState parent;
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
      ...
      DeletePermission1(clientUser: clientUser, parent: parent);
...
class DeletePermission1 extends StatefulWidget {
  ...
  DeletePermission1({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
...
class DeletePermissionPopup2 extends PopupRoute<void> {
  DeletePermissionPopup2({this.clientUser, this.parent});
  final _ClientProfileState parent;
  final ClientUser clientUser;
  @override
  Color get barrierColor => Color.fromARGB(255, 8, 8, 13).withOpacity(0.98);
  ...
  Widget buildPage(BuildContext context, Animation<double> animation,
          Animation<double> secondaryAnimation) =>
      DeletePermission2(clientUser: clientUser, parent: parent);

  @override
  Duration get transitionDuration => const Duration(milliseconds: 300);
}

class DeletePermission2 extends StatefulWidget {
  final _ClientProfileState parent;
  final ClientUser clientUser;

  DeletePermission2({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);

  @override
  State createState() => DeletePermission2State(clientUser: clientUser);
}

class DeletePermission2State extends State<DeletePermission2> {
  final ClientUser clientUser;
  DeletePermission2State({Key key, @required this.clientUser});
            ...
            children: <Widget>[
              ...
              Padding(
                padding: EdgeInsets.symmetric(
                    horizontal: 16 * prefs.getDouble('width')),
                child: Text(
                  "Are you sure you want to stop the training partnership with ${clientUser.firstName} ${clientUser.lastName}? The friendship will be deleted as well.",
                  style: TextStyle(
                    fontFamily: 'Roboto',
                    color: Color.fromARGB(120, 255, 255, 255),
                    fontSize: 12 * prefs.getDouble('height'),
