...
import 'package:Bsharkr/Trainer/My_Profile/Calendar.dart';
...
class MyProfilePage extends StatefulWidget {
  MyProfilePage({this.auth, this.onSignedOut, this.trainerUser, this.parent});
...
class _MyProfilePageState extends State<MyProfilePage>
  ...
  Future _signOut(BuildContext context) async {
    try {
      ...
      await prefs.setStringList('previousClients', null);
...
void showFeatureRequests() {
  ...
  Widget build(BuildContext context) {
    controller.forward();
    _trainerUser = widget.trainerUser;
                    ...
                    children: <Widget>[
                      Container(
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              padding: EdgeInsets.only(
                                  right: 24 * prefs.getDouble('width')),
                              ...
                              child: (_trainerUser.photoUrl == null
                                  ? ClipOval(
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Text(_trainerUser.firstName[0],
                                              style: TextStyle(
                                                  fontFamily: 'Roboto',
                                                  fontSize: 50 *
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(width: 10 * prefs.getDouble('width')),
                          Container(
                            width: 150 * prefs.getDouble('width'),
                            height: 32 * prefs.getDouble('height'),
                            child: Material(
                      ...
                      SizedBox(
                        height: 9.0 * prefs.getDouble('height'),
                      ),
                      Container(
                      ...
                      RepaintBoundary(
                        child: Container(
                          height: 157 * prefs.getDouble('height'),
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: <Widget>[
...
class MyPopupRoute1 extends PopupRoute<void> {
  ...
  final _MyProfilePageState parent;
...
class DetailsPageReviewsState extends State<DetailsPageReviews> {
  ...
  Widget buildItem(List<ReviewMapDelay> reviews, int index) {
    if (index < 5) {
      if (reviews.length <= 5) {
...
class _EditeazaProfilulState extends State<EditeazaProfilul> {
  ...
  Widget build(BuildContext context) {
    ...
    if (restart == false) {
      _trainerUser = widget.parent._trainerUser;
    ...
    if (_trainerUser.locationGeopoint != null) {
      ...
      _center = LatLng(44.441417, 26.101496);
    }
    return MaterialApp(
