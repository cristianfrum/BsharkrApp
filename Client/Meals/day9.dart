...
class NinethPage extends StatefulWidget {
  ...
  NinethPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _NinethPageState createState() =>
      _NinethPageState(clientUser: clientUser, parent: parent);
}

class _NinethPageState extends State<NinethPage> {
  final MyMealsState parent;
  final ClientUser clientUser;
  _NinethPageState({Key key, @required this.clientUser, @required this.parent});
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        daysOfTheWeek[widget.clientUser.scheduleSecondWeek.day2
                                    .toDate()
                                    .weekday -
                                1] +
                            ", " +
                            widget.clientUser.scheduleSecondWeek.day2
                                .toDate()
                                .day
                                .toString() +
                            " " +
                            monthsOfTheYear[widget
                                    .clientUser.scheduleSecondWeek.day2
                                    .toDate()
                                    .month -
                                1],
                        style: TextStyle(
