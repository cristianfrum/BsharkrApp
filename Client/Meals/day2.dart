...
class SecondPage extends StatefulWidget {
  ...
  SecondPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _SecondPageState createState() =>
      _SecondPageState(clientUser: clientUser, parent: parent);
}

class _SecondPageState extends State<SecondPage> {
  final MyMealsState parent;
  final ClientUser clientUser;
  _SecondPageState({Key key, @required this.clientUser, @required this.parent});
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  child: Text(
                    daysOfTheWeek[widget.clientUser.scheduleFirstWeek.day2
                                .toDate()
                                .weekday -
                            1] +
                        ", " +
                        widget.clientUser.scheduleFirstWeek.day2
                            .toDate()
                            .day
                            .toString() +
                        " " +
                        monthsOfTheYear[widget.clientUser.scheduleFirstWeek.day2
                                .toDate()
                                .month -
                            1],
                    style: TextStyle(
