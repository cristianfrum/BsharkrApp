...
class FifthPage extends StatefulWidget {
  ...
  FifthPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _FifthPageState createState() =>
      _FifthPageState(clientUser:clientUser, parent: parent);
}

class _FifthPageState extends State<FifthPage> {
  final MyMealsState parent;
  final ClientUser clientUser;
  _FifthPageState({Key key, @required this.clientUser, @required this.parent});
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  child: Text(daysOfTheWeek[widget.clientUser.scheduleFirstWeek.day5
                                                .toDate()
                                                .weekday -
                                            1] + ", " +
                        widget.clientUser.scheduleFirstWeek.day5
                            .toDate()
                            .day
                            .toString() +
                        " " +
                        monthsOfTheYear[
                            widget.clientUser.scheduleFirstWeek.day5.toDate().month -
                                1],
                    style: TextStyle(
            fontFamily: 'Roboto',
