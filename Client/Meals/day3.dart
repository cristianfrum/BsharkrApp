...
class ThirdPage extends StatefulWidget {
  ...
  ThirdPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _ThirdPageState createState() =>
      _ThirdPageState(clientUser: clientUser, parent: parent);
}

class _ThirdPageState extends State<ThirdPage> {
  final MyMealsState parent;
  final ClientUser clientUser;
  _ThirdPageState({Key key, @required this.clientUser, @required this.parent});
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  child: Text(
                    daysOfTheWeek[widget.clientUser.scheduleFirstWeek.day3
                                .toDate()
                                .weekday -
                            1] +
                        ", " +
                        widget.clientUser.scheduleFirstWeek.day3
                            .toDate()
                            .day
                            .toString() +
                        " " +
                        monthsOfTheYear[widget
                                .clientUser.scheduleFirstWeek.day3
                                .toDate()
                                .month -
                            1],
                    style: TextStyle(
