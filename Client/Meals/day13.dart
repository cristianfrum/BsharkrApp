...
class TirteenthPage extends StatefulWidget {
  final MyMealsState parent;
  final ClientUser clientUser;
  TirteenthPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _TirteenthPageState createState() =>
      _TirteenthPageState(clientUser: clientUser, parent: parent);
}

class _TirteenthPageState extends State<TirteenthPage> {
  final MyMealsState parent;
  final ClientUser clientUser;
  _TirteenthPageState(
              ...
              children: <Widget>[
               ...
               children: <Widget>[Container(),
                Container(
                  ...
                  child: Text(daysOfTheWeek[widget.clientUser.scheduleSecondWeek.day6
                                .toDate()
                                .weekday -
                            1] +
                        ", " +
                        widget.clientUser.scheduleSecondWeek.day6
                            .toDate()
                            .day
                            .toString() +
                        " " +
                        monthsOfTheYear[widget.clientUser.scheduleSecondWeek.day6
                                .toDate()
                                .month -
                            1],
                    style: TextStyle(
