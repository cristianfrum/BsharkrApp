...
class TwelfthPage extends StatefulWidget {
  ...
  TwelfthPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _TwelfthPageState createState() =>
      _TwelfthPageState(clientUser: clientUser, parent: parent);
}
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        daysOfTheWeek[widget.clientUser.scheduleSecondWeek.day5
                                    .toDate()
                                    .weekday -
                                1] +
                            ", " +
                            widget.clientUser.scheduleSecondWeek.day5
                                .toDate()
                                .day
                                .toString() +
                            " " +
                            monthsOfTheYear[widget
                                    .clientUser.scheduleSecondWeek.day5
                                    .toDate()
                                    .month -
                                1],
                        style: TextStyle(
