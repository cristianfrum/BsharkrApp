...
class SixthPage extends StatefulWidget {
  ...
  SixthPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _SixthPageState createState() =>
      _SixthPageState(clientUser: clientUser, parent: parent);
}

class _SixthPageState extends State<SixthPage> {
  final MyMealsState parent;
  final ClientUser clientUser;
  _SixthPageState({Key key, @required this.clientUser, @required this.parent});
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(daysOfTheWeek[widget.clientUser.scheduleFirstWeek.day6
                                                .toDate()
                                                .weekday -
                                            1] + ", " +
                        widget.clientUser.scheduleFirstWeek.day6
                            .toDate()
                            .day
                            .toString() +
                        " " +
                        monthsOfTheYear[
                            widget.clientUser.scheduleFirstWeek.day6.toDate().month -
                                1],
                    style: TextStyle(
            fontFamily: 'Roboto',
