...
class FourteenthPage extends StatefulWidget {
  ...
  FourteenthPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _FourteenthPageState createState() =>
      _FourteenthPageState(clientUser: clientUser, parent: parent);
}

class _FourteenthPageState extends State<FourteenthPage> {
  final MyMealsState parent;
  final ClientUser clientUser;
  _FourteenthPageState(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Text(
                        daysOfTheWeek[widget.clientUser.scheduleSecondWeek.day7
                                    .toDate()
                                    .weekday -
                                1] +
                            ", " +
                            widget.clientUser.scheduleSecondWeek.day7
                                .toDate()
                                .day
                                .toString() +
                            " " +
                            monthsOfTheYear[widget
                                    .clientUser.scheduleSecondWeek.day7
                                    .toDate()
                                    .month -
                                1],
                        style: TextStyle(
