...
class FirstPage extends StatefulWidget {
  ...
  FirstPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _FirstPageState createState() =>
      _FirstPageState(clientUser: clientUser, parent: parent);
}

class _FirstPageState extends State<FirstPage> {
  final MyMealsState parent;
  final ClientUser clientUser;
  _FirstPageState({Key key, @required this.clientUser, @required this.parent});
        ...
        Dialog(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                SizedBox(
                  height: 14 * prefs.getDouble('height'),
                ),
                ...
                children: <Widget>[
                  ...
                  child: Text(
                    daysOfTheWeek[widget.clientUser.scheduleFirstWeek.day1
                                .toDate()
                                .weekday -
                            1] +
                        ", " +
                        widget.clientUser.scheduleFirstWeek.day1
                            .toDate()
                            .day
                            .toString() +
                        " " +
                        monthsOfTheYear[widget.clientUser.scheduleFirstWeek.day1
                                .toDate()
                                .month -
                            1],
                    style: TextStyle(
