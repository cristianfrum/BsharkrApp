...
class EleventhPage extends StatefulWidget {
  ...
  EleventhPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _EleventhPageState createState() =>
      _EleventhPageState(clientUser:clientUser, parent: parent);
}
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                children: <Widget>[Container(),Container(
                  ...
                  child: Text(daysOfTheWeek[widget.clientUser.scheduleSecondWeek.day4
                                .toDate()
                                .weekday -
                            1] +
                        ", " +
                        widget.clientUser.scheduleSecondWeek.day4
                            .toDate()
                            .day
                            .toString() +
                        " " +
                        monthsOfTheYear[widget.clientUser.scheduleSecondWeek.day4
                                .toDate()
                                .month -
                            1],
                    style: TextStyle(
