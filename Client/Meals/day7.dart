...
class SeventhPage extends StatefulWidget {
  ...
  SeventhPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _SeventhPageState createState() =>
      _SeventhPageState(clientUser: clientUser, parent: parent);
}
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  child: Text(
                    daysOfTheWeek[widget.clientUser.scheduleFirstWeek.day7
                                .toDate()
                                .weekday -
                            1] +
                        ", " +
                        widget.clientUser.scheduleFirstWeek.day7
                            .toDate()
                            .day
                            .toString() +
                        " " +
                        monthsOfTheYear[widget
                                .clientUser.scheduleFirstWeek.day7
                                .toDate()
                                .month -
                            1],
                    style: TextStyle(
