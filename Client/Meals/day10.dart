...
class TenthPage extends StatefulWidget {
  ...
  TenthPage({Key key, @required this.clientUser, @required this.parent})
      : super(key: key);
  @override
  _TenthPageState createState() =>
      _TenthPageState(clientUser: clientUser, parent: parent);
}

class _TenthPageState extends State<TenthPage> {
  final MyMealsState parent;
  final ClientUser clientUser;
  _TenthPageState({Key key, @required this.clientUser, @required this.parent});
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                children: <Widget>[Container(),Container(
                  ...
                  child: Text(daysOfTheWeek[widget.clientUser.scheduleSecondWeek.day3
                                .toDate()
                                .weekday -
                            1] +
                        ", " +
                        widget.clientUser.scheduleSecondWeek.day3
                            .toDate()
                            .day
                            .toString() +
                        " " +
                        monthsOfTheYear[widget.clientUser.scheduleSecondWeek.day3
                                .toDate()
                                .month -
                            1],
                    style: TextStyle(
